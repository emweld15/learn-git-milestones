...
<h3>
  <ul>
    <li>This is part of my unordered list</li>
    <li>Aiming to complete adding markdowns</li>
</h3>
...
- [x] Set up a [Github page](https://pages.github.com/) "project site" for your repo
  ...
  - [x] Visit your project site at https://emweld15.github.io/learn-git-milestones/
